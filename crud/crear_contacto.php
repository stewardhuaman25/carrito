                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingresa tu DNI">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Apelidos y Nombres</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingresa Apellidos y Nombres">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingresa tu telefono">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Direccion</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingresabtu direccion">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Fecha de Nacimiento</label>
                                            <input type="date" id="simpleinput" class="form-control" placeholder="Ingresa tu fecha de nacimiento">
                                        </div>
